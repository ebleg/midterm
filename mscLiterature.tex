...
\include{notes/structure}
\include{notes/questions}

\include{main/introduction}
\include{main/finance}
\include{main/lorentz_plane}
\include{main/hyperbolic_geometry}
\include{main/ee}
\include{main/analytical_mechanics}

...
\paragraph{The Lorentz group} All the Lorentz transformations form a Lie group called the Lorentz group $\text{Lor}$. When applied to the four-dimensional Lorentzian vector space, i.e. $\real^4$ equipped with the Lorentz product, they can be regarded as the special orthogonal group for this space.
